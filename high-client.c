...
#define INITIAL_ENERGY 48600000
#define CURRENT_CPU 1.8
#define CURRENT_TX 17.4
...
PROCESS(udp_client_high_process, "UDP client high process");
AUTOSTART_PROCESSES(&udp_client_high_process);
...
PROCESS_THREAD(udp_client_high_process, ev, data) {
