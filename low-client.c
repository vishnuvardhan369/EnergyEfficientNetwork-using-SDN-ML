...
#define INITIAL_ENERGY 16200000
...
PROCESS(udp_client_low_process, "UDP client low process");
AUTOSTART_PROCESSES(&udp_client_low_process);
...
PROCESS_THREAD(udp_client_low_process, ev, data) {
